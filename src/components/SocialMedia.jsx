...
export const socialMediaProfiles = [
  { title: 'GitHub', href: 'https://github.com/mrwebwork', icon: GitHubIcon },
  {
    title: 'LinkedIn',
  ...
  // {
  //   title: "Facebook",
  //   href: "https://www.facebook.com/allanswebwork/",
  //   icon: FacebookIcon,
  // },
  // {
  //   title: "Instagram",
  //   href: "https://www.instagram.com/allanswebwork/?hl=en",
  //   icon: InstagramIcon,
  // },
  {
    title: 'Youtube',
    href: 'https://www.youtube.com/channel/UCl6QwQ5dkgAelVejMEW1yWA',
    icon: YoutubeIcon,
  },
  {
    title: 'Fiverr',
